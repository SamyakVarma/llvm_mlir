module attributes {dlti.dl_spec = #dlti.dl_spec<!llvm.ptr<270> = dense<32> : vector<4xi64>, !llvm.ptr<271> = dense<32> : vector<4xi64>, !llvm.ptr<272> = dense<64> : vector<4xi64>, i64 = dense<64> : vector<2xi64>, i128 = dense<128> : vector<2xi64>, f80 = dense<128> : vector<2xi64>, !llvm.ptr = dense<64> : vector<4xi64>, i1 = dense<8> : vector<2xi64>, i8 = dense<8> : vector<2xi64>, i16 = dense<16> : vector<2xi64>, i32 = dense<32> : vector<2xi64>, f16 = dense<16> : vector<2xi64>, f64 = dense<64> : vector<2xi64>, f128 = dense<128> : vector<2xi64>, "dlti.endianness" = "little", "dlti.mangling_mode" = "w", "dlti.legal_int_widths" = array<i32: 8, 16, 32, 64>, "dlti.stack_alignment" = 128 : i64>, llvm.ident = "clang version 22.1.2 (https://github.com/msys2/MINGW-packages 4f19d31560faf73257116b7c95f0b322ba83d720)", llvm.module_asm = [], llvm.target_triple = "x86_64-w64-windows-gnu"} {
  ...
  llvm.func @test_i32_tensor(%arg0: i64 {llvm.noundef}, %arg1: i64 {llvm.noundef}, %arg2: i64 {llvm.noundef}, %arg3: i64 {llvm.noundef}, %arg4: i32 {llvm.noundef}) -> i32 attributes {dso_local, no_inline, no_unwind, optimize_none, passthrough = [["min-legal-vector-width", "0"], ["no-trapping-math", "true"], ["stack-protector-buffer-size", "8"], ["target-cpu", "x86-64"]], target_cpu = "x86-64", target_features = #llvm.target_features<["+cmov", "+cx8", "+fxsr", "+mmx", "+sse", "+sse2", "+x87"]>, tune_cpu = "generic", uwtable_kind = #llvm.uwtableKind<async>} {
    ...
    llvm.store %arg4, %6 {alignment = 4 : i64} : i32, !llvm.ptr
    %8 = llvm.load %2 {alignment = 8 : i64} : !llvm.ptr -> i64
    %9 = llvm.load %3 {alignment = 8 : i64} : !llvm.ptr -> i64
    %10 = llvm.mul %8, %9 overflow<nsw> : i64
    %11 = llvm.mul %10, %1 : i64
    %12 = llvm.call @malloc(%11) {allocsize = array<i32: 0>} : (i64 {llvm.noundef}) -> !llvm.ptr
    ...
    %15 = llvm.load %4 {alignment = 8 : i64} : !llvm.ptr -> i64
    ...
    %20 = llvm.getelementptr inbounds %14[%19] : (!llvm.ptr, i64) -> !llvm.ptr, i32
    llvm.store %13, %20 {alignment = 4 : i64} : i32, !llvm.ptr
    %21 = llvm.load %7 {alignment = 8 : i64} : !llvm.ptr -> !llvm.ptr
    %22 = llvm.load %4 {alignment = 8 : i64} : !llvm.ptr -> i64
    %23 = llvm.load %3 {alignment = 8 : i64} : !llvm.ptr -> i64
    %24 = llvm.mul %22, %23 overflow<nsw> : i64
    %25 = llvm.load %5 {alignment = 8 : i64} : !llvm.ptr -> i64
    %26 = llvm.add %24, %25 overflow<nsw> : i64
    %27 = llvm.getelementptr inbounds %21[%26] : (!llvm.ptr, i64) -> !llvm.ptr, i32
    %28 = llvm.load %27 {alignment = 4 : i64} : !llvm.ptr -> i32
    llvm.return %28 : i32
  }
